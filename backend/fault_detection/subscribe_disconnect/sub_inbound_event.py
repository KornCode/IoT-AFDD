...
from fault_detection.subscribe_disconnect.routing_table import routing_table

logger = logging.getLogger(__name__)

QUEUE_NAME = "telemetry.fault_detection.disconnect.device"

PREFETCH_COUNT = 5


async def start_consumer():
    exchange_conf = RABBITMQ_EXCHANGES["telemetry.event"]
